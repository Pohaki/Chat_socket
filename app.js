...
io.on('connection', function(socket) {
  ...
  socket.on('add user', function(username) {
    ...
    socket.emit('new message', 'SERVER', 'You are connected on room1');
    socket.broadcast.to('room1').emit('new message', 'SERVER', username + ' is connected to this room');
  ...
  socket.on('switchRoom', function(newroom){
		...
		socket.room = newroom;
		socket.broadcast.to(newroom).emit('new message', 'SERVER', socket.username+' has joined this room');
